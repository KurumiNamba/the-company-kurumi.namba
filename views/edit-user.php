    ...
    <main class="row justify-content-center gx-0">
        <div class="col-4">
            ...
            <form action="../actions/edit-user-action.php" method="post" enctype="multipart/form-data">
                <!-- enctype="multipart/form-data" helps users to upload img -->
                 <div class="row justify-content-center mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="first_name" id="first-name" class="form-control fw-bold" value="<?=$user['first_name']?>" required autofocus>
                    </div>

                    <div class="mb-3">
                    <label for="last=name" class="form-label">Last Name</label>
                    <input type="text" name="last_name" id="last-name" class="form-control fw-bold" value="<?=$user['last_name']?>" required>
                    </div>
